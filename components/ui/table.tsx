...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-white/[0.05] transition-colors hover:bg-white/[0.025] data-[state=selected]:bg-indigo-500/10",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 whitespace-nowrap px-4 text-start align-middle text-xs font-medium uppercase tracking-wider text-muted",
      className,
    )}
    {...props}
  />
